 ...
 *
 */
public class QY_RZXYXXCheck implements ICheckWithParam {
	...
	public MessageResult Check(Map<String, Object> mapObject) throws Exception {
		...
		detachedCriteria = DetachedCriteria.forClass(Class.forName("zxptsystem.dto.AutoDTO_QY_RZXYXX"));
		...
		if(objectList.size()>=1){
			...
			messageResult.getMessageSet().add("同一基础段且业务发生日期相同的情况下，同一融资协议信息只可存在一笔");
		}
