...
public class BatchContext {
	...
	private BatchContext() {
		//baseHome = "C:\\Users\\Transino\\Desktop\\zxpt\\解密\\tolq\\tolq\\key\\person\\";
		baseHome = ServletActionContext.getServletContext().getRealPath("/")+"conf"+File.separatorChar+"qyzx"+File.separatorChar;
		System.out.println("baseHome:"+baseHome);
	...
	public synchronized void addPropetiry(String properityName,
			Object properityObject) {
