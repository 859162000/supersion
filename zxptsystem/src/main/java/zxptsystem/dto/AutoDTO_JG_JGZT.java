...
@Entity
@Table(name = "JG_JGZT")
@IEntity(description= "机构状态段")
public class AutoDTO_JG_JGZT implements java.io.Serializable{
	...
	@IColumn(tagMethodName="getJBHZTTag",description="基本户状态")
	@Column(name = "JBHZT", nullable =true)
	private String JBHZT;

	public static Map<String,String> getJBHZTTag() {
		try {
			return HelpTool.getSystemConstVal("JBHZT");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
	...
	public String getJBHZT() {
		return JBHZT;
	}

	public void setJBHZT(String in) {
		JBHZT = in;
	}

	@IColumn(tagMethodName="getQYGMTag",description="企业规模")
	@Column(name = "QYGM", nullable =true)
	private String QYGM;

	public static Map<String,String> getQYGMTag() {
		try {
			return HelpTool.getSystemConstVal("QYGM");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
	...
	public void setQYGM(String in) {
		QYGM = in;
	}

	@IColumn(tagMethodName="getJGZTTag",description="机构状态")
	@Column(name = "JGZT", nullable =true)
	private String JGZT;

	public static Map<String,String> getJGZTTag() {
		try {
			return HelpTool.getSystemConstVal("JGZT");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
