...
@Entity
@Table(name = "QY_JKRGZ_BS")
@IEntity(description= "借款人关注信息标识变更段")
public class AutoDTO_QY_JKRGZ_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("GZ_BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
