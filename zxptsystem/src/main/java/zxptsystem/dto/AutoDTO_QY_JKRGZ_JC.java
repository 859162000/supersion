...
import zxptsystem.dto.AutoDTO_QY_JKRGZ_BS;
import zxptsystem.dto.AutoDTO_QY_SSXX;
import zxptsystem.dto.AutoDTO_QY_DSXX;

@Entity
@Table(name = "QY_JKRGZ_JC")
@IEntity(description= "借款人关注信息基础段")
public class AutoDTO_QY_JKRGZ_JC implements java.io.Serializable{
	...
	private Set<zxptsystem.dto.AutoDTO_QY_JKRGZ_BS> OneToMany_QY_JKRGZ_BS= new HashSet<zxptsystem.dto.AutoDTO_QY_JKRGZ_BS>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_JKRGZ_BS> getOneToMany_QY_JKRGZ_BS() {
		return OneToMany_QY_JKRGZ_BS;
	}

	public void setOneToMany_QY_JKRGZ_BS(Set<zxptsystem.dto.AutoDTO_QY_JKRGZ_BS> in) {
		OneToMany_QY_JKRGZ_BS = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_SSXX> OneToMany_QY_SSXX= new HashSet<zxptsystem.dto.AutoDTO_QY_SSXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_SSXX> getOneToMany_QY_SSXX() {
		return OneToMany_QY_SSXX;
	}

	public void setOneToMany_QY_SSXX(Set<zxptsystem.dto.AutoDTO_QY_SSXX> in) {
		OneToMany_QY_SSXX = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_DSXX> OneToMany_QY_DSXX= new HashSet<zxptsystem.dto.AutoDTO_QY_DSXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_DSXX> getOneToMany_QY_DSXX() {
		return OneToMany_QY_DSXX;
	}

	public void setOneToMany_QY_DSXX(Set<zxptsystem.dto.AutoDTO_QY_DSXX> in) {
		OneToMany_QY_DSXX = in;
	}
