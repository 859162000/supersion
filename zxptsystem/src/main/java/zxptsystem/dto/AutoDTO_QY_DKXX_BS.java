...
@Entity
@Table(name = "QY_DKXX_BS")
@IEntity(description= "垫款信息标识变更段")
public class AutoDTO_QY_DKXX_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("DK_BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
