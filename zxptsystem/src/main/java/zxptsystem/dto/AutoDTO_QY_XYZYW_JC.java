...
import zxptsystem.dto.AutoDTO_QY_XYZYW_BS;
import zxptsystem.dto.AutoDTO_QY_XYZYWXX;

@Entity
@Table(name = "QY_XYZYW_JC")
@IEntity(description= "信用证业务信息基础段")
public class AutoDTO_QY_XYZYW_JC implements java.io.Serializable{
	...
	@Column(name = "XYZHM", length = 200, nullable = true)
	@IColumn(description="信用证号码")
	...
	public void setXYZHM(String in) {
		XYZHM = in;
	}
	...
	private Set<zxptsystem.dto.AutoDTO_QY_XYZYW_BS> OneToMany_QY_XYZYW_BS= new HashSet<zxptsystem.dto.AutoDTO_QY_XYZYW_BS>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_XYZYW_BS> getOneToMany_QY_XYZYW_BS() {
		return OneToMany_QY_XYZYW_BS;
	}

	public void setOneToMany_QY_XYZYW_BS(Set<zxptsystem.dto.AutoDTO_QY_XYZYW_BS> in) {
		OneToMany_QY_XYZYW_BS = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_XYZYWXX> OneToMany_QY_XYZYWXX= new HashSet<zxptsystem.dto.AutoDTO_QY_XYZYWXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_XYZYWXX> getOneToMany_QY_XYZYWXX() {
		return OneToMany_QY_XYZYWXX;
	}

	public void setOneToMany_QY_XYZYWXX(Set<zxptsystem.dto.AutoDTO_QY_XYZYWXX> in) {
		OneToMany_QY_XYZYWXX = in;
	}
