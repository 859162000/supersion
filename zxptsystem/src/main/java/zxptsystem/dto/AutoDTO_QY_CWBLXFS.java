...
@Entity
@Table(name = "QY_CWBLXFS")
@IEntity(description= "财务部联系方式")
public class AutoDTO_QY_CWBLXFS implements java.io.Serializable{
	...
	@Column(name = "CWBLXFS", length = 100, nullable = true)
	@IColumn(description="财务部联系方式")
	private String CWBLXFS;

	public String getCWBLXFS() {
		return CWBLXFS;
	}

	public void setCWBLXFS(String in) {
		CWBLXFS = in;
	}
