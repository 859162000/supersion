...
@Entity
@Table(name = "QY_GKSX_BS")
@IEntity(description= "公开授信信息标识变更段")
public class AutoDTO_QY_GKSX_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("GKSX_BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
