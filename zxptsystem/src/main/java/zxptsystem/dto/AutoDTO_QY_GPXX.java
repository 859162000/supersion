...
@Entity
@Table(name = "QY_GPXX")
@IEntity(description= "股票信息")
public class AutoDTO_QY_GPXX implements java.io.Serializable{
	...
	@Column(name = "GPDM", length = 50, nullable = true)
	@IColumn(description="股票代码")
	private String GPDM;
	...
	public void setGPDM(String in) {
		GPDM = in;
	}

	@IColumn(tagMethodName="getSSDTag",description="上市地")
	@Column(name = "SSD", nullable =true)
	private String SSD;

	public static Map<String,String> getSSDTag() {
		try {
			return HelpTool.getSystemConstVal("SSD");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
