...
@Entity
@Table(name = "QY_DBHTXX")
@IEntity(description= "保证合同信息段")
public class AutoDTO_QY_DBHTXX implements java.io.Serializable{
	...
	@Column(name = "BZRDDKKBM", length = 50, nullable = true)
	@IColumn(description="保证人贷款卡编码")
	private String BZRDDKKBM;

	public String getBZRDDKKBM() {
		return BZRDDKKBM;
	}

	public void setBZRDDKKBM(String in) {
		BZRDDKKBM = in;
	}
