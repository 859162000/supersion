...
@Entity
@Table(name = "QY_BLYW_BS")
@IEntity(description= "保理业务信息标识变更段")
public class AutoDTO_QY_BLYW_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("BL_BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
