...
import zxptsystem.dto.AutoDTO_QY_JKRGK_BS;
import zxptsystem.dto.AutoDTO_QY_JKRGKXX;
import zxptsystem.dto.AutoDTO_QY_CWBLXFS;
import zxptsystem.dto.AutoDTO_QY_GPXX;

@Entity
@Table(name = "QY_JKRGK_JC")
@IEntity(description= "借款人概况信息基础段")
public class AutoDTO_QY_JKRGK_JC implements java.io.Serializable{
	...
	private Set<zxptsystem.dto.AutoDTO_QY_JKRGK_BS> OneToMany_QY_JKRGK_BS= new HashSet<zxptsystem.dto.AutoDTO_QY_JKRGK_BS>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_JKRGK_BS> getOneToMany_QY_JKRGK_BS() {
		return OneToMany_QY_JKRGK_BS;
	}

	public void setOneToMany_QY_JKRGK_BS(Set<zxptsystem.dto.AutoDTO_QY_JKRGK_BS> in) {
		OneToMany_QY_JKRGK_BS = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_JKRGKXX> OneToMany_QY_JKRGKXX= new HashSet<zxptsystem.dto.AutoDTO_QY_JKRGKXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_JKRGKXX> getOneToMany_QY_JKRGKXX() {
		return OneToMany_QY_JKRGKXX;
	}

	public void setOneToMany_QY_JKRGKXX(Set<zxptsystem.dto.AutoDTO_QY_JKRGKXX> in) {
		OneToMany_QY_JKRGKXX = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_CWBLXFS> OneToMany_QY_CWBLXFS= new HashSet<zxptsystem.dto.AutoDTO_QY_CWBLXFS>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_CWBLXFS> getOneToMany_QY_CWBLXFS() {
		return OneToMany_QY_CWBLXFS;
	}

	public void setOneToMany_QY_CWBLXFS(Set<zxptsystem.dto.AutoDTO_QY_CWBLXFS> in) {
		OneToMany_QY_CWBLXFS = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_GPXX> OneToMany_QY_GPXX= new HashSet<zxptsystem.dto.AutoDTO_QY_GPXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_GPXX> getOneToMany_QY_GPXX() {
		return OneToMany_QY_GPXX;
	}

	public void setOneToMany_QY_GPXX(Set<zxptsystem.dto.AutoDTO_QY_GPXX> in) {
		OneToMany_QY_GPXX = in;
	}
