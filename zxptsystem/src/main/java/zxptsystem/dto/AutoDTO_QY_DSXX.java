...
@Entity
@Table(name = "QY_DSXX")
@IEntity(description= "大事信息")
public class AutoDTO_QY_DSXX implements java.io.Serializable{
	...
	@Column(name = "DSXXJLLSH", length = 200, nullable = true)
	@IColumn(description="大事信息记录流水号")
	private String DSXXJLLSH;

	public String getDSXXJLLSH() {
		return DSXXJLLSH;
	}

	public void setDSXXJLLSH(String in) {
		DSXXJLLSH = in;
	}

	@Column(name = "DSMS", length = 500, nullable = true)
	@IColumn(description="大事描述")
	private String DSMS;
