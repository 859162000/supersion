...
@Entity
@Table(name = "QY_ZRRDYHTXX")
@IEntity(description= "自然人抵押合同信息段")
public class AutoDTO_QY_ZRRDYHTXX implements java.io.Serializable{
	...
	@Column(name = "DYHTBH", length = 200, nullable = true)
	...
	public void setDYHTBH(String in) {
		DYHTBH = in;
	}
	...
	@IColumn(tagMethodName="getBZ_1Tag",description="币种")
	@Column(name = "BZ_1", nullable =true)
	private String BZ_1;

	public static Map<String,String> getBZ_1Tag() {
		try {
	...
	@IColumn(tagMethodName="getBZ_2Tag",description="币种")
	@Column(name = "BZ_2", nullable =true)
	private String BZ_2;

	public static Map<String,String> getBZ_2Tag() {
		try {
			return HelpTool.getSystemConstVal("BZ");
		} catch (Exception e) {
			e.printStackTrace();
