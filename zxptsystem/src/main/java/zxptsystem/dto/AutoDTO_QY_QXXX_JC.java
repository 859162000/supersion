...
import zxptsystem.dto.AutoDTO_QY_QXXX_BS;
import zxptsystem.dto.AutoDTO_QY_QXYWXX;

@Entity
@Table(name = "QY_QXXX_JC")
@IEntity(description= "欠息信息基础段")
public class AutoDTO_QY_QXXX_JC implements java.io.Serializable{
	...
	private Set<zxptsystem.dto.AutoDTO_QY_QXXX_BS> OneToMany_QY_QXXX_BS= new HashSet<zxptsystem.dto.AutoDTO_QY_QXXX_BS>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_QXXX_BS> getOneToMany_QY_QXXX_BS() {
		return OneToMany_QY_QXXX_BS;
	}

	public void setOneToMany_QY_QXXX_BS(Set<zxptsystem.dto.AutoDTO_QY_QXXX_BS> in) {
		OneToMany_QY_QXXX_BS = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_QXYWXX> OneToMany_QY_QXYWXX= new HashSet<zxptsystem.dto.AutoDTO_QY_QXYWXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_QXYWXX> getOneToMany_QY_QXYWXX() {
		return OneToMany_QY_QXYWXX;
	}

	public void setOneToMany_QY_QXYWXX(Set<zxptsystem.dto.AutoDTO_QY_QXYWXX> in) {
		OneToMany_QY_QXYWXX = in;
	}
