...
@Entity
@Table(name = "GR_JZDZ")
@IEntity(description= "居住地址段")
public class AutoDTO_GR_JZDZ implements java.io.Serializable{
	...
	public void setZJDZYZBM(String in) {
		ZJDZYZBM = in;
	}

	@IColumn(tagMethodName="getZJZKTag",description="居住状况")
	@Column(name = "ZJZK", nullable =true)
	private String ZJZK;

	public static Map<String,String> getZJZKTag() {
		try {
			return HelpTool.getSystemConstVal("JZZK");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
