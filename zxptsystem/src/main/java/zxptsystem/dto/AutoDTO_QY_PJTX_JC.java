...
import zxptsystem.dto.AutoDTO_QY_PJTX_BS;
import zxptsystem.dto.AutoDTO_QY_TXYWXX;

@Entity
@Table(name = "QY_PJTX_JC")
@IEntity(description= "票据贴现业务信息基础段")
public class AutoDTO_QY_PJTX_JC implements java.io.Serializable{
	...
	@Column(name = "PJNBBH", length = 200, nullable = true)
	@IColumn(description="票据内部编号")
	private String PJNBBH;

	public String getPJNBBH() {
		return PJNBBH;
	}

	public void setPJNBBH(String in) {
		PJNBBH = in;
	}
	...
	private Set<zxptsystem.dto.AutoDTO_QY_PJTX_BS> OneToMany_QY_PJTX_BS= new HashSet<zxptsystem.dto.AutoDTO_QY_PJTX_BS>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_PJTX_BS> getOneToMany_QY_PJTX_BS() {
		return OneToMany_QY_PJTX_BS;
	}

	public void setOneToMany_QY_PJTX_BS(Set<zxptsystem.dto.AutoDTO_QY_PJTX_BS> in) {
		OneToMany_QY_PJTX_BS = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_TXYWXX> OneToMany_QY_TXYWXX= new HashSet<zxptsystem.dto.AutoDTO_QY_TXYWXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_TXYWXX> getOneToMany_QY_TXYWXX() {
		return OneToMany_QY_TXYWXX;
	}

	public void setOneToMany_QY_TXYWXX(Set<zxptsystem.dto.AutoDTO_QY_TXYWXX> in) {
		OneToMany_QY_TXYWXX = in;
	}
