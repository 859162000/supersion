...
@Entity
@Table(name = "QY_XYZYW_BS")
@IEntity(description= "信用证业务信息标识变更段")
public class AutoDTO_QY_XYZYW_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("XYZ_BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
