...
import zxptsystem.dto.AutoDTO_QY_GKSX_BS;
import zxptsystem.dto.AutoDTO_QY_SXYWXX;

@Entity
@Table(name = "QY_GKSX_JC")
@IEntity(description= "公开授信信息基础段")
public class AutoDTO_QY_GKSX_JC implements java.io.Serializable{
	...
	private Set<zxptsystem.dto.AutoDTO_QY_GKSX_BS> OneToMany_QY_GKSX_BS= new HashSet<zxptsystem.dto.AutoDTO_QY_GKSX_BS>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_GKSX_BS> getOneToMany_QY_GKSX_BS() {
		return OneToMany_QY_GKSX_BS;
	}

	public void setOneToMany_QY_GKSX_BS(Set<zxptsystem.dto.AutoDTO_QY_GKSX_BS> in) {
		OneToMany_QY_GKSX_BS = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_SXYWXX> OneToMany_QY_SXYWXX= new HashSet<zxptsystem.dto.AutoDTO_QY_SXYWXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_SXYWXX> getOneToMany_QY_SXYWXX() {
		return OneToMany_QY_SXYWXX;
	}

	public void setOneToMany_QY_SXYWXX(Set<zxptsystem.dto.AutoDTO_QY_SXYWXX> in) {
		OneToMany_QY_SXYWXX = in;
	}
