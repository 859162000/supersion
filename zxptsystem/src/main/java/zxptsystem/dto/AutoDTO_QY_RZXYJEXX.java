...
@Entity
@Table(name = "QY_RZXYJEXX")
@IEntity(description= "融资协议金额信息段")
public class AutoDTO_QY_RZXYJEXX implements java.io.Serializable{
	...
	@Column(name = "RZXYJE", length = 50, nullable = true)
	@IColumn(description="融资协议金额")
	private String RZXYJE;

	public String getRZXYJE() {
		return RZXYJE;
	}

	public void setRZXYJE(String in) {
		RZXYJE = in;
	}

	@Column(name = "RZXYYE", length = 50, nullable = true)
	@IColumn(description="融资协议余额")
	private String RZXYYE;

	public String getRZXYYE() {
		return RZXYYE;
	}

	public void setRZXYYE(String in) {
		RZXYYE = in;
	}
