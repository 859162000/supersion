...
@Entity
@Table(name = "QY_DKYW_BS")
@IEntity(description= "贷款业务信息标识变更段")
public class AutoDTO_QY_DKYW_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("DKYW_BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
