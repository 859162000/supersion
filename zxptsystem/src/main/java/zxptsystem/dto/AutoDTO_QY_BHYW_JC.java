...
import zxptsystem.dto.AutoDTO_QY_BHYW_BS;
import zxptsystem.dto.AutoDTO_QY_BHYWXX;

@Entity
@Table(name = "QY_BHYW_JC")
@IEntity(description= "保函业务信息基础段")
public class AutoDTO_QY_BHYW_JC implements java.io.Serializable{
	...
	@Column(name = "BHHM", length = 200, nullable = true)
	@IColumn(description="保函号码")
	private String BHHM;
	...
	private Set<zxptsystem.dto.AutoDTO_QY_BHYW_BS> OneToMany_QY_BHYW_BS= new HashSet<zxptsystem.dto.AutoDTO_QY_BHYW_BS>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_BHYW_BS> getOneToMany_QY_BHYW_BS() {
		return OneToMany_QY_BHYW_BS;
	}

	public void setOneToMany_QY_BHYW_BS(Set<zxptsystem.dto.AutoDTO_QY_BHYW_BS> in) {
		OneToMany_QY_BHYW_BS = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_BHYWXX> OneToMany_QY_BHYWXX= new HashSet<zxptsystem.dto.AutoDTO_QY_BHYWXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_BHYWXX> getOneToMany_QY_BHYWXX() {
		return OneToMany_QY_BHYWXX;
	}

	public void setOneToMany_QY_BHYWXX(Set<zxptsystem.dto.AutoDTO_QY_BHYWXX> in) {
		OneToMany_QY_BHYWXX = in;
	}
