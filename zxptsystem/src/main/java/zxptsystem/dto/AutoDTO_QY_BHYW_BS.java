...
@Entity
@Table(name = "QY_BHYW_BS")
@IEntity(description= "保函业务信息标识变更段")
public class AutoDTO_QY_BHYW_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("BH_BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
