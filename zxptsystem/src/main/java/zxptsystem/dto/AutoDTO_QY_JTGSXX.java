...
@Entity
@Table(name = "QY_JTGSXX")
@IEntity(description= "集团公司信息")
public class AutoDTO_QY_JTGSXX implements java.io.Serializable{
	...
	@Column(name = "SJGSMC", length = 200, nullable = true)
	@IColumn(description="上级公司名称")
	...
	public void setSJGSMC(String in) {
		SJGSMC = in;
	}

	@Column(name = "SJGSDDKKBM", length = 50, nullable = true)
	@IColumn(description="贷款卡编码")
	private String SJGSDDKKBM;

	public String getSJGSDDKKBM() {
		return SJGSDDKKBM;
	}

	public void setSJGSDDKKBM(String in) {
		SJGSDDKKBM = in;
	}
