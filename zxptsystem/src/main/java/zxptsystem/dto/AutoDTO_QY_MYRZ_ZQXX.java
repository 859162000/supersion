...
@Entity
@Table(name = "QY_MYRZ_ZQXX")
@IEntity(description= "展期信息段")
public class AutoDTO_QY_MYRZ_ZQXX implements java.io.Serializable{
	...
	@Column(name = "ZQCS", length = 50, nullable = true)
	...
	@Column(name = "ZQJE", length = 50, nullable = true)
	...
	@Column(name = "ZQQSRQ", length = 50, nullable = true)
	@IColumn(description="展期起始日期")
	...
	public void setZQQSRQ(String in) {
		ZQQSRQ = in;
	}

	@Column(name = "ZQDQRQ", length = 50, nullable = true)
