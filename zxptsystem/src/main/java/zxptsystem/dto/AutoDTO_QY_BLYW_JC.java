...
import zxptsystem.dto.AutoDTO_QY_BLYW_BS;
import zxptsystem.dto.AutoDTO_QY_BLXZXX;

@Entity
@Table(name = "QY_BLYW_JC")
@IEntity(description= "保理业务信息基础段")
public class AutoDTO_QY_BLYW_JC implements java.io.Serializable{
	...
	@Column(name = "BLXYBH", length = 200, nullable = true)
	@IColumn(description="保理协议编号")
	...
	public void setBLXYBH(String in) {
		BLXYBH = in;
	}
	...
	private Set<zxptsystem.dto.AutoDTO_QY_BLYW_BS> OneToMany_QY_BLYW_BS= new HashSet<zxptsystem.dto.AutoDTO_QY_BLYW_BS>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_BLYW_BS> getOneToMany_QY_BLYW_BS() {
		return OneToMany_QY_BLYW_BS;
	}

	public void setOneToMany_QY_BLYW_BS(Set<zxptsystem.dto.AutoDTO_QY_BLYW_BS> in) {
		OneToMany_QY_BLYW_BS = in;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "FOREIGNID")
	private Set<zxptsystem.dto.AutoDTO_QY_BLXZXX> OneToMany_QY_BLXZXX= new HashSet<zxptsystem.dto.AutoDTO_QY_BLXZXX>(0);

	public Set<zxptsystem.dto.AutoDTO_QY_BLXZXX> getOneToMany_QY_BLXZXX() {
		return OneToMany_QY_BLXZXX;
	}

	public void setOneToMany_QY_BLXZXX(Set<zxptsystem.dto.AutoDTO_QY_BLXZXX> in) {
		OneToMany_QY_BLXZXX = in;
	}
