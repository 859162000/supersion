...
@Entity
@Table(name = "QY_YHCDHP_BS")
@IEntity(description= "银行承兑汇票业务信息标识变更段")
public class AutoDTO_QY_YHCDHP_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("CDHP_BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
