...
@Entity
@Table(name = "JG_SJJG")
@IEntity(description= "上级机构（主管单位）段")
public class AutoDTO_JG_SJJG implements java.io.Serializable{
	...
	@Column(name = "SJJGMC", length = 200, nullable = true)
	@IColumn(description="上级机构名称")
	...
	public void setSJJGMC(String in) {
		SJJGMC = in;
	}

	@IColumn(tagMethodName="getSJJGDJZCHLXTag",description="登记注册号类型")
	@Column(name = "SJJGDJZCHLX", nullable =true)
	private String SJJGDJZCHLX;

	public static Map<String,String> getSJJGDJZCHLXTag() {
		try {
	...
	public String getSJJGDJZCHLX() {
		return SJJGDJZCHLX;
	}

	public void setSJJGDJZCHLX(String in) {
		SJJGDJZCHLX = in;
	}

	@Column(name = "SJJGDJZCHM", length = 50, nullable = true)
	@IColumn(description="登记注册号")
	private String SJJGDJZCHM;

	public String getSJJGDJZCHM() {
		return SJJGDJZCHM;
	}

	public void setSJJGDJZCHM(String in) {
		SJJGDJZCHM = in;
	}

	@Column(name = "SJJGZZJGDM", length = 50, nullable = true)
	@IColumn(description="组织机构代码")
	private String SJJGZZJGDM;

	public String getSJJGZZJGDM() {
		return SJJGZZJGDM;
	}

	public void setSJJGZZJGDM(String in) {
		SJJGZZJGDM = in;
	}
	...
	@Column(name = "SJJGXXGXRQ", length = 50, nullable = true)
	@IColumn(description="信息更新日期")
	private String SJJGXXGXRQ;

	public String getSJJGXXGXRQ() {
		return SJJGXXGXRQ;
	}

	public void setSJJGXXGXRQ(String in) {
		SJJGXXGXRQ = in;
	}
