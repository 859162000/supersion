...
@Entity
@Table(name = "QY_JKRZBGC_BS")
@IEntity(description= "借款人资本构成标识标识变更")
public class AutoDTO_QY_JKRZBGC_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
