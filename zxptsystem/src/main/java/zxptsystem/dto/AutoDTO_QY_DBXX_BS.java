...
@Entity
@Table(name = "QY_DBXX_BS")
@IEntity(description= "担保信息标识变更段")
public class AutoDTO_QY_DBXX_BS implements java.io.Serializable{
	...
	public static Map<String,String> getBGLXTag() {
		try {
			return HelpTool.getSystemConstVal("DB_BGLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
