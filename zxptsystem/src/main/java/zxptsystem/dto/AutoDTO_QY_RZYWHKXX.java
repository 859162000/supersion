...
@Entity
@Table(name = "QY_RZYWHKXX")
@IEntity(description= "融资业务还款信息段")
public class AutoDTO_QY_RZYWHKXX implements java.io.Serializable{
	...
	@Column(name = "HKCS", length = 50, nullable = true)
	@IColumn(description="还款次数")
	private String HKCS;
	...
	public void setHKCS(String in) {
		HKCS = in;
	}

	@Column(name = "HKJE", length = 50, nullable = true)
	@IColumn(description="还款金额")
	private String HKJE;
	...
	public void setHKJE(String in) {
		HKJE = in;
	}

	@Column(name = "HKRQ", length = 50, nullable = true)
	@IColumn(description="还款日期")
	private String HKRQ;
