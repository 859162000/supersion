...
import baseDataGenerateProcess_zxptsystem.zxptsystem.QYZXReportGenerate;
...
@SuiteClasses(value={
	...
	QYZXReportGenerate.class
})
public class QYZXGenerateReportTest{
	...
	public static void deleteTestData(){
		try {
			...
			ActionTestUtils.deleteFilePath(System.getProperty("java.io.tmpdir")+"QYZXReportFile");
		} catch (Exception e) {
