...
@Entity
@Table(name = "NCR_2_5")
@IEntity(description= "关联集团信息")
public class AutoDTO_NCR_2_5 implements java.io.Serializable{
	...
	@IColumn(tagMethodName="getCTag",description="关联关系类型")
	@Column(name = "C", nullable =true)
	private String C;

	public static Map<String,String> getCTag() {
		return ShowContext.getInstance().getShowEntityMap().get("NCR_RELA_RELA_TYPE");
	}
