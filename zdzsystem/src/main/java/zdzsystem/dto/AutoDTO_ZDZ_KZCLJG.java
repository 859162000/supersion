...
@Entity
@Table(name = "ZDZ_KZCLJG")
@IEntity(description= "控制处理结果")
public class AutoDTO_ZDZ_KZCLJG implements java.io.Serializable{
	...
	@IColumn(tagMethodName="getKZNRTag",description="控制内容")
	...
	@IColumn(tagMethodName="getKZZTTag",description="控制结果")
	@Column(name = "KZZT", nullable =true)
	private String KZZT;

	public static Map<String,String> getKZZTTag() {
		try {
			return HelpTool.getSystemConstVal("ZDZ_KZZT");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
	...
	public void setKZZT(String in) {
		KZZT = in;
	}

	@Column(name = "YE", length = 255, nullable = true)
	...
	@Column(name = "CSKSRQ", length = 50, nullable = true)
	@IColumn(description="措施始期")
	...
	public void setCSKSRQ(String in) {
		CSKSRQ = in;
	}

	@Column(name = "CSJSRQ", length = 50, nullable = true)
	@IColumn(description="措施终期")
	...
	public void setCSJSRQ(String in) {
		CSJSRQ = in;
	}

	@Column(name = "DJXE", length = 255, nullable = true)
	@IColumn(description="冻结限额")
	private String DJXE;
	...
	public void setDJXE(String in) {
		DJXE = in;
	}

	@Column(name = "SKJE", length = 255, nullable = true)
	@IColumn(description="实际控制可用金额（数额）")
	private String SKJE;
	...
	public void setSKJE(String in) {
		SKJE = in;
	}

	@Column(name = "CESKJE", length = 255, nullable = true)
	@IColumn(description="超额控制金额（数额）")
	...
	public void setCESKJE(String in) {
		CESKJE = in;
	}

	@Column(name = "WNKZYY", length = 2000, nullable = true)
	@IColumn(description="未能控制原因")
	...
	public void setWNKZYY(String in) {
		WNKZYY = in;
	}
