...
@Entity
@Table(name = "ZDZ_GLZLZHXX")
@IEntity(description= "关联子类账户信息")
public class AutoDTO_ZDZ_GLZLZHXX implements java.io.Serializable{
	...
	@Column(name = "GLXH", length = 255, nullable = true)
	@IColumn(description="子账户序号")
	private String GLXH;
	...
	public void setGLXH(String in) {
		GLXH = in;
	}

	@Column(name = "ZKHZH", length = 50, nullable = true)
	@IColumn(description="主账户账号")
	...
	public void setZKHZH(String in) {
		ZKHZH = in;
	}

	@Column(name = "GLZHLB", length = 50, nullable = true)
	@IColumn(description="子账号类别")
	...
	public void setGLZHLB(String in) {
		GLZHLB = in;
	}

	@Column(name = "GLZHHM", length = 100, nullable = true)
	@IColumn(description="子账号账号")
