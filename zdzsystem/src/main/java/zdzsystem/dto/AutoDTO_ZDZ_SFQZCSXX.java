...
@Entity
@Table(name = "ZDZ_SFQZCSXX")
@IEntity(description= "司法强制措施信息")
public class AutoDTO_ZDZ_SFQZCSXX implements java.io.Serializable{
	...
	@Column(name = "DJJZRQ", length = 100, nullable = true)
	@IColumn(description="冻结截止日")
