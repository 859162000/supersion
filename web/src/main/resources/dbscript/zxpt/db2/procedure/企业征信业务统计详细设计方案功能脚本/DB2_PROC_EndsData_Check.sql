CREATE PROCEDURE PROC_ENDSDATA_CHECK
(
	IN p_VERSION VARCHAR(3),
	IN p_REPORTINST VARCHAR(50),
	IN p_ENDDATE VARCHAR(8),
...
SELECT DKKBM,FOREIGNID,MAX(QY_HTXX.EXTEND2) AS EXTEND2 FROM QY_HTXX,QY_DKYW_JC,REPORTINSTSUBINFO WHERE QY_HTXX.FOREIGNID = QY_DKYW_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_HTXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_DKYW_JC.XXJLCZLX = '1' AND QY_HTXX.RPTFEEDBACKTYPE = '2' GROUP BY DKKBM,FOREIGNID) TEMP WHERE NOT EXISTS(
...
SELECT * FROM (SELECT FOREIGNID,JJBH,MAX(QY_JJXX.EXTEND2) AS EXTEND2 FROM QY_JJXX,QY_DKYW_JC,REPORTINSTSUBINFO WHERE QY_JJXX.FOREIGNID = QY_DKYW_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_JJXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_DKYW_JC.XXJLCZLX = '1' AND QY_JJXX.RPTFEEDBACKTYPE = '2' GROUP BY FOREIGNID,JJBH) TEMP 
...
SELECT * FROM (SELECT FOREIGNID,MAX(QY_BLXZXX.EXTEND2) AS EXTEND2 FROM QY_BLXZXX,QY_BLYW_JC,REPORTINSTSUBINFO WHERE QY_BLXZXX.FOREIGNID = QY_BLYW_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_BLXZXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_BLYW_JC.XXJLCZLX = '1' AND QY_BLXZXX.RPTFEEDBACKTYPE = '2' GROUP BY FOREIGNID) TEMP 
...
SELECT * FROM (SELECT FOREIGNID,MAX(QY_TXYWXX.EXTEND2) AS EXTEND2 FROM QY_TXYWXX,QY_PJTX_JC,REPORTINSTSUBINFO WHERE QY_TXYWXX.FOREIGNID = QY_PJTX_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_TXYWXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_PJTX_JC.XXJLCZLX = '1' AND QY_TXYWXX.RPTFEEDBACKTYPE = '2' GROUP BY FOREIGNID) TEMP 
...
SELECT * FROM (SELECT FOREIGNID,RZYWBH,MAX(QY_RZYWXX.EXTEND2) AS EXTEND2 FROM QY_RZYWXX,QY_MYRZ_JC,REPORTINSTSUBINFO WHERE QY_RZYWXX.FOREIGNID = QY_MYRZ_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_RZYWXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_MYRZ_JC.XXJLCZLX = '1' AND QY_RZYWXX.RPTFEEDBACKTYPE = '2' GROUP BY FOREIGNID,RZYWBH) TEMP 
...
SELECT * FROM (SELECT FOREIGNID,MAX(QY_BHYWXX.EXTEND2) AS EXTEND2 FROM QY_BHYWXX,QY_BHYW_JC,REPORTINSTSUBINFO WHERE QY_BHYWXX.FOREIGNID = QY_BHYW_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_BHYWXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_BHYW_JC.XXJLCZLX = '1' AND QY_BHYWXX.RPTFEEDBACKTYPE = '2' GROUP BY FOREIGNID) TEMP 
...
SELECT * FROM (SELECT FOREIGNID,MAX(QY_SXYWXX.EXTEND2) AS EXTEND2 FROM QY_SXYWXX,QY_GKSX_JC,REPORTINSTSUBINFO WHERE QY_SXYWXX.FOREIGNID = QY_GKSX_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_SXYWXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_GKSX_JC.XXJLCZLX = '1' AND QY_SXYWXX.RPTFEEDBACKTYPE = '2' GROUP BY FOREIGNID) TEMP 
...
SELECT * FROM (SELECT BZRDDKKBM,BZHTBH,MAX(QY_DBHTXX.EXTEND2) AS EXTEND2 FROM QY_DBHTXX,QY_DBXX_JC,REPORTINSTSUBINFO WHERE QY_DBHTXX.FOREIGNID = QY_DBXX_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_DBHTXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_DBXX_JC.XXJLCZLX = '1' AND QY_DBHTXX.RPTFEEDBACKTYPE = '2' AND QY_DBHTXX.HTYXZT = '1' GROUP BY BZRDDKKBM,BZHTBH) TEMP 
...
SELECT * FROM (SELECT DYRDKKBM,DYHTBM,DYXH,MAX(QY_DYHTXX.EXTEND2) AS EXTEND2 FROM QY_DYHTXX,QY_DBXX_JC,REPORTINSTSUBINFO WHERE QY_DYHTXX.FOREIGNID = QY_DBXX_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_DYHTXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_DBXX_JC.XXJLCZLX = '1' AND QY_DYHTXX.RPTFEEDBACKTYPE = '2' AND QY_DYHTXX.HTYXZT = '1' GROUP BY DYRDKKBM,DYHTBM,DYXH) TEMP 
...
SELECT * FROM (SELECT CZRDDKKBM,ZYHTBH,ZYXH,MAX(QY_ZYHTXX.EXTEND2) AS EXTEND2 FROM QY_ZYHTXX,QY_DBXX_JC,REPORTINSTSUBINFO WHERE QY_ZYHTXX.FOREIGNID = QY_DBXX_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_ZYHTXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_DBXX_JC.XXJLCZLX = '1' AND QY_ZYHTXX.RPTFEEDBACKTYPE = '2' AND QY_ZYHTXX.HTYXZT = '1' GROUP BY CZRDDKKBM,ZYHTBH,ZYXH) TEMP 
...
SELECT * FROM (SELECT FOREIGNID,MAX(QY_DKYWXX.EXTEND2) AS EXTEND2 FROM QY_DKYWXX,QY_DKXX_JC,REPORTINSTSUBINFO WHERE QY_DKYWXX.FOREIGNID = QY_DKXX_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_DKYWXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_DKXX_JC.XXJLCZLX = '1' AND QY_DKYWXX.RPTFEEDBACKTYPE = '2' GROUP BY FOREIGNID) TEMP 
...
SELECT * FROM (SELECT ZJLX,ZJHM,BZHTBH,MAX(QY_ZRRBZHTXX.EXTEND2) AS EXTEND2 FROM QY_ZRRBZHTXX,QY_DBXX_JC,REPORTINSTSUBINFO WHERE QY_ZRRBZHTXX.FOREIGNID = QY_DBXX_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_ZRRBZHTXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_DBXX_JC.XXJLCZLX = '1' AND QY_ZRRBZHTXX.RPTFEEDBACKTYPE = '2' AND QY_ZRRBZHTXX.HTYXZT = '1' GROUP BY ZJLX,ZJHM,BZHTBH) TEMP 
...
SELECT * FROM (SELECT ZJLX,ZJHM,DYHTBH,DYXH,MAX(QY_ZRRDYHTXX.EXTEND2) AS EXTEND2 FROM QY_ZRRDYHTXX,QY_DBXX_JC,REPORTINSTSUBINFO WHERE QY_ZRRDYHTXX.FOREIGNID = QY_DBXX_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_ZRRDYHTXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_DBXX_JC.XXJLCZLX = '1' AND QY_ZRRDYHTXX.RPTFEEDBACKTYPE = '2' AND QY_ZRRDYHTXX.HTYXZT = '1' GROUP BY ZJLX,ZJHM,DYHTBH,DYXH) TEMP 
...
SELECT * FROM (SELECT ZJLX,ZJHM,ZYHTBH,ZYXH,MAX(QY_ZRRZYHTXX.EXTEND2) AS EXTEND2 FROM QY_ZRRZYHTXX,QY_DBXX_JC,REPORTINSTSUBINFO WHERE QY_ZRRZYHTXX.FOREIGNID = QY_DBXX_JC.AUTOID AND INSTINFO = STRINSTCODE AND QY_ZRRZYHTXX.EXTEND2 <= p_ENDDATE AND strReportInstCode = p_REPORTINST AND QY_DBXX_JC.XXJLCZLX = '1' AND QY_ZRRZYHTXX.RPTFEEDBACKTYPE = '2' AND QY_ZRRZYHTXX.HTYXZT = '1' GROUP BY ZJLX,ZJHM,ZYHTBH,ZYXH) TEMP 
