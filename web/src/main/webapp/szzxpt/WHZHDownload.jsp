...
<html>
	<head>
		...
		<script type="text/javascript">
	        ...
	        function ReportMakeConfirm(actionNamespace,actionName,page){
	            ...
	            var u1="<%=basePath %>ajaxForWHZHReport/GetJsonForWHZHDownLoadReport-szzxpt.dto.WHZHDownload.action";
				...
				$.ajax({
					...
					if(conRes==true)
					{
						var actionname="DownloadXML-szzxpt.dto.WHZHDownload.action";
    ...
    function onSelectChange(){
		document.form1.action="<%=basePath%>framework/ShowList-szzxpt.dto.WHZHDownload.action";
		document.form1.submit();
	}
