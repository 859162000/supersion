			...
			<div id="Table_Frame_Div" class="Table_Frame_Div">
				<table id="Grid_Task" class="Grid_Table" border="1px"  cellpadding="0" cellspacing="0" Rules=rows>
					<tr id="JS_Grid_Head_Row" class="JS_Grid_Head_Row">
						...
						<!-- <td title="数据库" class="JS_Grid_Head_Row_Cell" style="width: 80px;">
							<div class="TD_Div_Nowrap">数据库</div>
						</td>
						<td title="应用" class="JS_Grid_Head_Row_Cell" style="width: 80px;">
							<div class="TD_Div_Nowrap">应用</div>
						</td>
						<td title="数据库" class="JS_Grid_Head_Row_Cell" style="width: 80px;">
							<div class="TD_Div_Nowrap">配置</div>
						</td> -->
					...
					<s:else>
						<s:iterator value="serviceResult.valueTable" id="vt" status="st">
							<tr class="JS_Grid_Data_Row" style="font-size: 12px; font-family: 微软雅黑;" Rows_Type='DataRow'>
								...
								<%-- <td title="数据库" class="JS_Grid_Data_Row_CellLink" style="width: 80px;" columncode="ColA"> 
								     <a id="from1_" href="framework/ShowList-jmx.dto.J_Db.action?windowId=JDb&serviceParam.server.uuid=<s:property value="%{#vt.get(0).value}"/>" style="color:#4169E1;">数据库</a>
								</td>
								<td title="web应用" class="JS_Grid_Data_Row_CellLink" style="width: 80px;" columncode="ColA"> 
								     <a id="from1_" href="framework/ShowList-jmx.dto.J_App.action?windowId=JApp&serviceParam.server.uuid=<s:property value="%{#vt.get(0).value}"/>" style="color:#4169E1;">web应用</a>
								</td>
								<td title="配置管理" class="JS_Grid_Data_Row_CellLink" style="width: 80px;" columncode="ColA"> 
								     <a id="from1_" href="" style="color:#4169E1;">配置管理</a>
								</td> --%>
								<td title="查看" class="JS_Grid_Data_Row_CellLink" style="width: 80px;" columncode="ColA"> 
								     <a id="from1_" href="jmx/showServerChart.action?windowId=<s:property value="windowId"/>&type=J_Server&sid=<s:property value="%{#vt.get(0).value}"/>&pid=0&cfq=s" style="color:#4169E1;">查看</a>
								</td>
							</tr>
						</s:iterator>
					</s:else>
