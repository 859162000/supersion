...
<html>
    ...
    function onSelectChange(){
		document.form1.action="<%=basePath%>framework/ShowList-bxywsystem.dto.BXYWDownload.action";
		document.form1.submit();
	}
	...
	<body onResize="AutiSize();" style="margin:0px; cursor: default; width: 100%;height:100%;" onload="ShowHeadName();" ondragstart="return false;">
