...
<html>
	<head>
		...
		<script type="text/javascript">
	        ...
	        function ReportMakeConfirm(actionNamespace,actionName,page){
	            ...
	            var u1="<%=basePath %>ajaxForReport/GetJsonForDownLoadReport-zxptsystem.dto.GRZXDownload.action";
				$.ajax({
					type:"post",
		            url:u1,
		            data:params,
					...
					if(conRes==true)
					{
						var actionname="DownLoadGRZXRport-zxptsystem.dto.GRZXDownload.action";
    ...
    function onSelectChange(){
		document.form1.action="<%=basePath%>framework/ShowList-zxptsystem.dto.GRZXDownload.action";
		document.form1.submit();
	}
