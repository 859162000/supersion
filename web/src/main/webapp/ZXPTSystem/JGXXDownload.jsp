...
<html>
	<head>
		...
		<script type="text/javascript">
	        ...
	        function ReportMakeConfirm(actionNamespace,actionName,page){
	            var reportType=$("#serviceParam.strJgReportType").val();
	            var jrjgcode=$("#serviceParam.strJgJRJGCode").val();
	            var ywfsrq=$("#serviceParam.XXGXRQ").val();
	            var params=$("#from1").serialize();
	            var u1="<%=basePath %>ajaxForReport/GetJsonForDownLoadReport-zxptsystem.dto.JGXXDownload.action";
				$.ajax({
					type:"post",
		            url:u1,
		            data:params,
					...
					if(conRes==true)
					{
						var actionname="DownLoadJGXXRport-zxptsystem.dto.JGXXDownload.action";
    ...
    function onSelectChange(){
		document.form1.action="<%=basePath%>framework/ShowList-zxptsystem.dto.JGXXDownload.action";
		document.form1.submit();
	}
						...
						<div class="Select_Menu_Control_Frame_Div">
							...
							<div class="Select_Menu_SelectBox_Div">
								<div class="Select_Menu_SelectBox_Div_Hidden">
								    <s:if test="%{#sr.paramName=='strJgReportType'}"><s:select cssClass="Select_Menu_SelectBox_Div_Option"
										list="#sr.tag"
