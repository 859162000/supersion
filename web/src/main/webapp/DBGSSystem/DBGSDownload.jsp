...
<html>
	<head>
		...
		<script type="text/javascript">
	        ...
	        function ReportMakeConfirm(actionNamespace,actionName,page){
	            ...
	            var ywfsrq=$("#serviceParam.SJBGRQ").val();
	            var jrjgcode=$("#serviceParam.strJRJGCode").val();

	            var params=$("#from1").serialize();

	            var u1="<%=basePath %>ajaxForDBGSReport/GetJsonForDBGSDownLoadReport-dbgssystem.dto.DBGSDownload.action";
				...
				$.ajax({
					...
					if(conRes==true)
					{
						var actionname="DownLoadDBGSRport-dbgssystem.dto.DBGSDownload.action";
    ...
    function onSelectChange(){
		document.form1.action="<%=basePath%>framework/ShowList-dbgssystem.dto.DBGSDownload.action";
		document.form1.submit();
	}
