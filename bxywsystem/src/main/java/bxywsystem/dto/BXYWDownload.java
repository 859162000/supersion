...
@Entity
@Table(name = "BXYWDownload")
@IEntity(navigationName="保险业务生成报文",description="保险业务生成报文")
public class BXYWDownload implements java.io.Serializable{
	...
	public static Map<String,String> getReportTypeTag(){
		return ShowContext.getInstance().getShowEntityMap().get("BX_ReportType");
	}
	...
	public static Map<String,String> getJRJGCodeTag() throws Exception{
		...
		detachedCriteria.add(Restrictions.or(Restrictions.eq("suit.strSuitCode","25"),Restrictions.isNull("suit.strSuitCode")));
	...
	@Column(name = "BBZRLX",length = 50, nullable =true)
