...
@Entity
@Table(name = "BX_SCQQJL")
@IEntity(description= "删除请求记录")
public class AutoDTO_BX_SCQQJL implements java.io.Serializable{
	...
	@IColumn(tagMethodName="getSCLXTag",description="删除类型")
	@Column(name = "SCLX", nullable =true)
	private String SCLX;

	public static Map<String,String> getSCLXTag() {
		try {
			return HelpTool.getSystemConstVal("SCLX");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
