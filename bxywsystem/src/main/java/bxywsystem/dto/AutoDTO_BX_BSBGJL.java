...
@Entity
@Table(name = "BX_BSBGJL")
@IEntity(description= "标识变更记录")
public class AutoDTO_BX_BSBGJL implements java.io.Serializable{
	...
	@Column(name = "YBDBH", length = 150, nullable = true)
	@IColumn(description="原保单编号")
	private String YBDBH;

	public String getYBDBH() {
		return YBDBH;
	}

	public void setYBDBH(String in) {
		YBDBH = in;
	}

	@Column(name = "BGHDBDBH", length = 150, nullable = true)
	@IColumn(description="变更后的保单编号")
	private String BGHDBDBH;

	public String getBGHDBDBH() {
		return BGHDBDBH;
	}

	public void setBGHDBDBH(String in) {
		BGHDBDBH = in;
	}
