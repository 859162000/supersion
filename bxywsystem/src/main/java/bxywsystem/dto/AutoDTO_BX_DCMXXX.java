...
@Entity
@Table(name = "BX_DCMXXX")
@IEntity(description= "代偿明细信息")
public class AutoDTO_BX_DCMXXX implements java.io.Serializable{
	...
	@Column(name = "DCRQ", length = 50, nullable = true)
	@IColumn(description="代偿日期")
	private String DCRQ;
	...
	public void setDCRQ(String in) {
		DCRQ = in;
	}

	@Column(name = "DCJE", length = 50, nullable = true)
	@IColumn(description="代偿金额")
	private String DCJE;
