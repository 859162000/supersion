...
public class ComponentObjectSaveOrUpdateService extends BaseVoidDaoResultService implements IComponentObjectService {
	...
	private Map<String,String> dtoCheckInstanceMap;

	public ComponentObjectSaveOrUpdateService()  {
		super();
	}
	...
	public void init() throws Exception {
		...
		this.setDefaultProceseClassList(Arrays.asList(new String[]{defaultProceseClass}));
	 	...
	 	LogicParamManager.setDtoCheckInstanceMap(dtoCheckInstanceMap);
	...
	public void setDefaultComponentAddClassList(List<String> defaultComponentAddClassList) {
	...
	public void setDefaultComponentCheckClassList(List<String> defaultComponentCheckClassList) {
	...
	public void setDefaultComponentTranslateClassList(List<String> defaultComponentTranslateClassList) {
	...
	public void setDefaultComponentProceseClassList(List<String> defaultComponentProceseClassList) {
		this.defaultComponentProceseClassList = defaultComponentProceseClassList;
	}
	
	public Map<String,String> getDtoCheckInstanceMap()
	{
		return this.dtoCheckInstanceMap;
	}
	public void setDtoCheckInstanceMap(Map<String,String> dtoCheckInstanceMap)
	{
		this.dtoCheckInstanceMap=dtoCheckInstanceMap;
	}
