...
public class SingleObjectImportDataService extends BaseVoidDaoResultService {
    ...
    public void initSuccessResult() throws Exception {
		...
		String message = fileHandlerForExcel.WriteFromPathToDatabase(showInstance, "sessionFactory", 
				...
				deleteOld, detachedCriteria, afterIgnorSeg, startLine, startCol, insertCheckClassList);
