...
public class AutoDTO_WGJ_ACC_CA_Condition  implements java.io.Serializable {
	...
	@ICondition(target="BUSINESS_DATE",description="开始业务日期",comparison=Comparison.GE)
	private Date startDate;
	
	@ICondition(target="BUSINESS_DATE",description="结束业务日期",comparison=Comparison.LE)
