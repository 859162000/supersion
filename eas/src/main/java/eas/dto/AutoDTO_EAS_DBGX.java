...
@Entity
@Table(name = "EAS_DBGX")
@IEntity(description= "担保关系")
public class AutoDTO_EAS_DBGX implements java.io.Serializable{
	...
	@Column(name = "BDBHTH", length = 299, nullable = true)
	@IColumn(description="被担保合同号")
	...
	public void setBDBHTH(String in) {
		BDBHTH = in;
	}
	...
	@Column(name = "DBJE", length = 20, nullable = true)
	...
	public void setDBJE(String in) {
		DBJE = TypeParse.parseBigDecimal(in);
	}
	...
	public static Map<String,String> getDBZTTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_GUAR_STATUS");
	}
	...
	@Column(name = "JLDBYGH", length = 299, nullable = true)
	@IColumn(description="建立担保员工号")
	...
	public void setJLDBYGH(String in) {
		JLDBYGH = in;
	}
