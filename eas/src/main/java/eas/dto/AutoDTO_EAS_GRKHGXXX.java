...
@Entity
@Table(name = "EAS_GRKHGXXX")
@IEntity(description= "个人客户关系信息")
public class AutoDTO_EAS_GRKHGXXX implements java.io.Serializable{
	...
	@Column(name = "DYGRKHTYBH", length = 299, nullable = true)
	@IColumn(description="对应个人客户统一编号")
	...
	public void setDYGRKHTYBH(String in) {
		DYGRKHTYBH = in;
	}

	@Column(name = "SHGX", length = 299, nullable = true)
	@IColumn(description="社会关系")
	private String SHGX;
	...
	public void setSHGX(String in) {
		SHGX = in;
	}

	@Column(name = "DYGRKHXM", length = 299, nullable = true)
	@IColumn(description="对应个人客户姓名")
	...
	public void setDYGRKHXM(String in) {
		DYGRKHXM = in;
	}

	@Column(name = "DYGRKHGZDWMC", length = 299, nullable = true)
	@IColumn(description="对应个人客户工作单位名称")
	...
	public void setDYGRKHGZDWMC(String in) {
		DYGRKHGZDWMC = in;
	}

	@Column(name = "DYGRKHGZDWDZ", length = 500, nullable = true)
	@IColumn(description="对应个人客户工作单位地址")
	...
	public void setDYGRKHGZDWDZ(String in) {
		DYGRKHGZDWDZ = in;
	}

	@Column(name = "DYGRKHGZDWDH", length = 299, nullable = true)
	@IColumn(description="对应个人客户工作单位电话")
	...
	public void setDYGRKHGZDWDH(String in) {
		DYGRKHGZDWDH = in;
	}
