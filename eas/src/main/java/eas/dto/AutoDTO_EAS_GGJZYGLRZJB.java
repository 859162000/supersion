...
@Entity
@Table(name = "EAS_GGJZYGLRZJB")
@IEntity(description= "高管及重要关联人证件表")
public class AutoDTO_EAS_GGJZYGLRZJB implements java.io.Serializable{
	...
	@Column(name = "ZJLX", length = 299, nullable = true)
	@IColumn(description="其它证件类型")
	private String ZJLX;
	...
	@Column(name = "QFRQ", length = 299, nullable = true)
