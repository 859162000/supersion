...
@Entity
@Table(name = "EAS_BHYWXXB")
@IEntity(description= "保函业务信息表")
public class AutoDTO_EAS_BHYWXXB implements java.io.Serializable{
	...
	@IColumn(tagMethodName="getBHYWPZTag",description="保函业务品种")
	@Column(name = "BHYWPZ", nullable =true)
	private String BHYWPZ;

	public static Map<String,String> getBHYWPZTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_GUAR_BIZ_BREED");
	}

	public String getBHYWPZ() {
		return BHYWPZ;
	}

	public void setBHYWPZ(String in) {
		BHYWPZ = in;
	}
	...
	@Column(name = "BHQSRQ", length = 299, nullable = true)
	@IColumn(description="保函起始日期")
	private String BHQSRQ;

	public String getBHQSRQ() {
		return BHQSRQ;
	}

	public void setBHQSRQ(String in) {
		BHQSRQ = in;
	}

	@Column(name = "BHDQRQ", length = 299, nullable = true)
	@IColumn(description="保函到期日期")
	private String BHDQRQ;

	public String getBHDQRQ() {
		return BHDQRQ;
	}

	public void setBHDQRQ(String in) {
		BHDQRQ = in;
	}
	...
	@Column(name = "DKLL", nullable = true)
	@IColumn(description="垫款利率(万分之一)")
	...
	public void setDKLL(String in) {
		DKLL = TypeParse.parseBigDecimal(in);
	}

	@Column(name = "SXFL", nullable = true)
	@IColumn(description="手续费率(万分之一)")
	private BigDecimal SXFL;

	public BigDecimal getSXFL() {
		return SXFL;
	}

	public void setSXFL(String in) {
		SXFL = TypeParse.parseBigDecimal(in);
	}
