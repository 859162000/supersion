...
@Entity
@Table(name = "EAS_GRXDYWJJ")
@IEntity(description= "个人信贷业务借据")
public class AutoDTO_EAS_GRXDYWJJ implements java.io.Serializable{
	...
	@Column(name = "XDYYGH", length = 299, nullable = true)
	@IColumn(description="信贷员员工号")
	private String XDYYGH;

	public String getXDYYGH() {
		return XDYYGH;
	}

	public void setXDYYGH(String in) {
		XDYYGH = in;
	}
	...
	@IColumn(tagMethodName="getSTZFBZTag",description="受托支付标志")
	@Column(name = "STZFBZ", nullable =true)
	private String STZFBZ;

	public static Map<String,String> getSTZFBZTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_ENTR_PAY_IND");
	}
