...
@Entity
@Table(name = "EAS_YGB")
@IEntity(description= "员工表")
public class AutoDTO_EAS_YGB implements java.io.Serializable{
	...
	@Column(name = "SFZH", length = 299, nullable = true)
	@IColumn(description="身份证号")
	private String SFZH;
	...
	@Column(name = "SSBM", length = 299, nullable = true)
	@IColumn(description="所属部门")
	private String SSBM;
	...
	public void setSSBM(String in) {
		SSBM = in;
	}

	@Column(name = "ZW", length = 299, nullable = true)
	...
	@Column(name = "YGZT", length = 299, nullable = true)
	@IColumn(description="员工状态")
	private String YGZT;
