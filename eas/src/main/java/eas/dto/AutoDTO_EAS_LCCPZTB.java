...
@Entity
@Table(name = "EAS_LCCPZTB")
@IEntity(description= "理财产品状态表")
public class AutoDTO_EAS_LCCPZTB implements java.io.Serializable{
	...
	@Column(name = "SJMJJE", length = 20, nullable = true)
	@IColumn(description="实际募集金额")
	...
	public void setSJMJJE(String in) {
		SJMJJE = TypeParse.parseBigDecimal(in);
	}

	@Column(name = "CPQSRQ", length = 8, nullable = true)
	@IColumn(description="产品起始日期")
	...
	public void setCPQSRQ(String in) {
		CPQSRQ = in;
	}

	@Column(name = "CPYJZZRQ", length = 8, nullable = true)
	@IColumn(description="产品预计终止日期")
	...
	public void setCPYJZZRQ(String in) {
		CPYJZZRQ = in;
	}

	@Column(name = "FXDJR", length = 8, nullable = true)
	@IColumn(description="发行登记日")
	...
	public void setFXDJR(String in) {
		FXDJR = in;
	}

	@Column(name = "YHDSJSXSR", length = 20, nullable = true)
	@IColumn(description="银行端实际实现收入")
	...
	public void setYHDSJSXSR(String in) {
		YHDSJSXSR = TypeParse.parseBigDecimal(in);
	}

	@Column(name = "DFKHSY", length = 20, nullable = true)
	@IColumn(description="兑付客户收益")
	...
	public void setDFKHSY(String in) {
		DFKHSY = TypeParse.parseBigDecimal(in);
	}

	@Column(name = "KHDSJNHSYL", length = 299, nullable = true)
	@IColumn(description="客户端实际年化收益率")
	...
	public void setKHDSJNHSYL(String in) {
		KHDSJNHSYL = TypeParse.parseBigDecimal(in);
	}

	@Column(name = "CPDSJNHSYL", length = 299, nullable = true)
	@IColumn(description="产品端实际年化收益率")
	...
	public void setCPDSJNHSYL(String in) {
		CPDSJNHSYL = TypeParse.parseBigDecimal(in);
	}

	@Column(name = "ZZDJR", length = 8, nullable = true)
	@IColumn(description="终止登记日")
	...
	public void setZZDJR(String in) {
		ZZDJR = in;
	}
