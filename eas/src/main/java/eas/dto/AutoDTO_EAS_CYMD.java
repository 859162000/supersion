...
@Entity
@Table(name = "EAS_CYMD")
@IEntity(description= "集团基本情况-成员名单")
public class AutoDTO_EAS_CYMD implements java.io.Serializable{
	...
	@Column(name = "CYDWDMC", length = 299, nullable = true)
	@IColumn(description="成员单位的名称")
	private String CYDWDMC;

	public String getCYDWDMC() {
		return CYDWDMC;
	}

	public void setCYDWDMC(String in) {
		CYDWDMC = in;
	}
	...
	@IColumn(tagMethodName="getCYLXTag",description="成员类型")
	@Column(name = "CYLX", nullable =true)
	private String CYLX;

	public static Map<String,String> getCYLXTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_MEM_TYPE");
	}
	...
	public void setCYLX(String in) {
		CYLX = in;
	}

	@IColumn(tagMethodName="getMGSBSTag",description="母公司标识")
	@Column(name = "MGSBS", nullable =true)
	private String MGSBS;

	public static Map<String,String> getMGSBSTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_CORP_IDTFY");
	}

	public String getMGSBS() {
		return MGSBS;
	}

	public void setMGSBS(String in) {
		MGSBS = in;
	}
