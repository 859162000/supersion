...
@Entity
@Table(name = "EAS_NBFHZMXJL")
@IEntity(description= "内部分户账明细记录")
public class AutoDTO_EAS_NBFHZMXJL implements java.io.Serializable{
	...
	@Column(name = "DFKMBH", length = 299, nullable = true)
	@IColumn(description="对方科目编号")
	private String DFKMBH;

	public String getDFKMBH() {
		return DFKMBH;
	}

	public void setDFKMBH(String in) {
		DFKMBH = in;
	}

	@Column(name = "DFKMMC", length = 299, nullable = true)
	@IColumn(description="对方科目名称")
	...
	public void setDFKMMC(String in) {
		DFKMMC = in;
	}
	...
	@Column(name = "DFKMH", length = 299, nullable = true)
	@IColumn(description="对方科目号")
	private String DFKMH;

	public String getDFKMH() {
		return DFKMH;
	}

	public void setDFKMH(String in) {
		DFKMH = in;
	}

	@Column(name = "JZRQ", length = 8, nullable = true)
	@IColumn(description="进账日期")
	private String JZRQ;
	...
	@Column(name = "XZRQ", length = 8, nullable = true)
	@IColumn(description="销账日期")
	private String XZRQ;
