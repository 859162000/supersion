...
@Entity
@Table(name = "EAS_ZCFZKMTJB")
@IEntity(description= "资产负债科目统计表")
public class AutoDTO_EAS_ZCFZKMTJB implements java.io.Serializable{
	...
	@Column(name = "QXLX", length = 299, nullable = true)
	@IColumn(description="期限类型")
	private String QXLX;
