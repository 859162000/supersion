...
@Entity
@Table(name = "EAS_GRDQCKFHZ")
@IEntity(description= "个人定期存款分户账")
public class AutoDTO_EAS_GRDQCKFHZ implements java.io.Serializable{
	...
	@Column(name = "GRKHTYBH", length = 299, nullable = true)
	@IColumn(description="客户统一编号")
	private String GRKHTYBH;

	public String getGRKHTYBH() {
		return GRKHTYBH;
	}

	public void setGRKHTYBH(String in) {
		GRKHTYBH = in;
	}
	...
	@Column(name = "GRDQCKZHLX", length = 299, nullable = true)
	@IColumn(description="个人定期存款账户类型")
	private String GRDQCKZHLX;

	public String getGRDQCKZHLX() {
		return GRDQCKZHLX;
	}

	public void setGRDQCKZHLX(String in) {
		GRDQCKZHLX = in;
	}
	...
	@Column(name = "DQR", length = 8, nullable = true)
