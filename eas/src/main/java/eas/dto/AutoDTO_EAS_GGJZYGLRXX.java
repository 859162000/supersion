...
@Entity
@Table(name = "EAS_GGJZYGLRXX")
@IEntity(description= "高管及重要关联人信息")
public class AutoDTO_EAS_GGJZYGLRXX implements java.io.Serializable{
	...
	@IColumn(tagMethodName="getGXRLXTag",description="关系人类型")
	@Column(name = "GXRLX", nullable =true)
	private String GXRLX;

	public static Map<String,String> getGXRLXTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_RELA_PERSON_TYPE_2_2");
	}
	...
	public void setGXRLX(String in) {
		GXRLX = in;
	}

	@Column(name = "XM", length = 299, nullable = true)
	...
	@Column(name = "GXXXRQ", length = 299, nullable = true)
