...
@Entity
@Table(name = "EAS_GWXXB")
@IEntity(description= "岗位信息表")
public class AutoDTO_EAS_GWXXB implements java.io.Serializable{
	...
	@Column(name = "GWZL", length = 299, nullable = true)
	@IColumn(description="岗位种类")
	private String GWZL;
	...
	public void setGWZL(String in) {
		GWZL = in;
	}

	@Column(name = "GWMC", length = 299, nullable = true)
	@IColumn(description="岗位名称")
	private String GWMC;
	...
	public void setGWMC(String in) {
		GWMC = in;
	}

	@Column(name = "GWSM", length = 500, nullable = true)
	@IColumn(description="岗位说明")
	private String GWSM;
	...
	public void setGWSM(String in) {
		GWSM = in;
	}

	@Column(name = "GWZT", length = 299, nullable = true)
	@IColumn(description="岗位状态")
	private String GWZT;
