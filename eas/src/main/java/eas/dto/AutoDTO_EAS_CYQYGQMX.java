...
@Entity
@Table(name = "EAS_CYQYGQMX")
@IEntity(description= "授信情况-持有企业股权明细")
public class AutoDTO_EAS_CYQYGQMX implements java.io.Serializable{
	...
	@Column(name = "YXCGQYMC", length = 299, nullable = true)
	@IColumn(description="银行持股企业名称")
	private String YXCGQYMC;

	public String getYXCGQYMC() {
		return YXCGQYMC;
	}

	public void setYXCGQYMC(String in) {
		YXCGQYMC = in;
	}

	@Column(name = "YXCGQYDM", length = 299, nullable = true)
	@IColumn(description="银行持股企业代码")
	private String YXCGQYDM;

	public String getYXCGQYDM() {
		return YXCGQYDM;
	}

	public void setYXCGQYDM(String in) {
		YXCGQYDM = in;
	}
