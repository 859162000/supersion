...
@Entity
@Table(name = "EAS_DGDQCKFHZMXJL")
@IEntity(description= "对公定期存款分户账明细记录")
public class AutoDTO_EAS_DGDQCKFHZMXJL implements java.io.Serializable{
	...
	@IColumn(tagMethodName="getBFTQZQBZTag",description="部分提前支取标志")
	@Column(name = "BFTQZQBZ", nullable =true)
	private String BFTQZQBZ;

	public static Map<String,String> getBFTQZQBZTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_PART_UNEXP_DRAW_IND");
	}
	...
	public void setBFTQZQBZ(String in) {
		BFTQZQBZ = in;
	}
