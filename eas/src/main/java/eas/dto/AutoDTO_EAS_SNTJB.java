...
@Entity
@Table(name = "EAS_SNTJB")
@IEntity(description= "涉农统计表")
public class AutoDTO_EAS_SNTJB implements java.io.Serializable{
	...
	@Column(name = "JRJGDM", length = 299, nullable = true)
	...
	@Column(name = "TJKMJE", length = 20, nullable = true)
	@IColumn(description="统计科目金额")
	...
	public void setTJKMJE(String in) {
		TJKMJE = TypeParse.parseBigDecimal(in);
	}

	@IColumn(tagMethodName="getQXLXTag",description="期限类型")
	@Column(name = "QXLX", nullable =true)
	private String QXLX;

	public static Map<String,String> getQXLXTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_TERM_TYPE");
	}
	...
	@Column(name = "TJRQ", length = 8, nullable = true)
	@IColumn(description="统计日期")
	private String TJRQ;
	...
	@Column(name = "DQMC", length = 299, nullable = true)
	@IColumn(description="地区名称")
	private String DQMC;
