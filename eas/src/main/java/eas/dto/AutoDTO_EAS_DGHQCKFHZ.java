...
@Entity
@Table(name = "EAS_DGHQCKFHZ")
@IEntity(description= "对公活期存款分户账")
public class AutoDTO_EAS_DGHQCKFHZ implements java.io.Serializable{
	...
	@IColumn(tagMethodName="getDGHQCKZHLXTag",description="对公活期存款账户类型")
	@Column(name = "DGHQCKZHLX", nullable =true)
	private String DGHQCKZHLX;

	public static Map<String,String> getDGHQCKZHLXTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_CORP_CURR_DP_ACC_TYPE");
	}
	...
	public void setDGHQCKZHLX(String in) {
		DGHQCKZHLX = in;
	}
