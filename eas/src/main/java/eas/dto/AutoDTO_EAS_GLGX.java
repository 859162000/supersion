...
@Entity
@Table(name = "EAS_GLGX")
@IEntity(description= "关联关系")
public class AutoDTO_EAS_GLGX implements java.io.Serializable{
	...
	@Column(name = "GLRKHTYBH", length = 299, nullable = true)
	@IColumn(description="关联人客户统一编号")
	...
	public void setGLRKHTYBH(String in) {
		GLRKHTYBH = in;
	}

	@Column(name = "KHSBM", length = 299, nullable = true)
	@IColumn(description="客户识别码")
	...
	public void setKHSBM(String in) {
		KHSBM = in;
	}
	...
	@Column(name = "GLRSBM", length = 299, nullable = true)
	@IColumn(description="关联人识别码")
	...
	public void setGLRSBM(String in) {
		GLRSBM = in;
	}

	@Column(name = "GLRMC", length = 299, nullable = true)
	@IColumn(description="关联人名称")
	...
	public void setGLRMC(String in) {
		GLRMC = in;
	}

	@IColumn(tagMethodName="getGLRLBTag",description="关联人类别")
	@Column(name = "GLRLB", nullable =true)
	private String GLRLB;

	public static Map<String,String> getGLRLBTag() {
		return ShowContext.getInstance().getShowEntityMap().get("EAS_RELA_PERSON_CATE");
	}
	...
	public void setGLRLB(String in) {
		GLRLB = in;
	}

	@IColumn(tagMethodName="getGXLXTag",description="关系类型")
	@Column(name = "GXLX", nullable =true)
	private String GXLX;

	public static Map<String,String> getGXLXTag() {
	...
	public void setGXLX(String in) {
		GXLX = in;
	}

	@Column(name = "GLGXZT", length = 299, nullable = true)
	@IColumn(description="关联关系状态")
	...
	public void setGLGXZT(String in) {
		GLGXZT = in;
	}

	@Column(name = "LRSJ", length = 299, nullable = true)
	@IColumn(description="录入时间")
	private String LRSJ;
