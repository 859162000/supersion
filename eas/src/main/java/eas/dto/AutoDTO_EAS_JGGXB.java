...
@Entity
@Table(name = "EAS_JGGXB")
@IEntity(description= "机构关系表")
public class AutoDTO_EAS_JGGXB implements java.io.Serializable{
	...
	@Column(name = "SJGLJGDM", length = 299, nullable = true)
	@IColumn(description="上级管理机构代码")
	...
	public void setSJGLJGDM(String in) {
		SJGLJGDM = in;
	}
